  ...
  state: {
    ...
    priceTable: [
      [ [5000, 5000, 9000, 13000, 17000, 21000, 25000, 29000, 33000 ], 
        ...
        [28000, 28000, 39000, 50000, 61000, 72000, 83000, 94000, 105000],
      ...
      [ [35000, 35000, 39000, 43000, 47000, 51000, 55000, 59000, 63000],
        ...
        [75000, 75000, 91000, 107000, 123000, 139000, 155000, 171000, 187000],
    ...
    Template : [    
      ...
      {"title" : "어떻게 설문 템플릿을 공유받을 수 있나요?","detail":"설문 템플릿을 신청하시면 작성해주신 이메일로 템플릿 링크를 공유해드립니다.\n최대 하루 정도 소요되므로, 이 점 유의하시어 서비스 이용 부탁드립니다."},
      {"title" : "설문 템플릿에 있는 문항을 바꿔도 되나요?","detail":"구글폼 권한이 '편집자'로 설정되어있기에 공유 받으신 설문 템플릿은 추후 고객님께서 자유롭게 문항 수정, 추가, 삭제 모두 가능합니다.\n 단, 설문 템플릿은 서베이지 저작물로, 제3자와의 공유는 절대 불가합니다."},
    ],

    MemberInfo : [
      { "title" : "아이디/비밀번호는 어디서 변경할 수 있나요?", "detail":"[아이디 변경] 서베이지 카카오톡 채널 @surveasy로 연락주시면 도와드리겠습니다.\n[비밀번호 변경] LOGIN 페이지에서 ‘비밀번호 찾기’ 버튼을 누르신 뒤 안내에 따라 비밀번호를 변경하시면 됩니다."},
      { "title" : "결제 내역은 어디서 확인할 수 있나요?", "detail":"로그인 후, 화면 상단 우측에 뜨는 본인의 아이디를 클릭하여 ‘마이페이지’로 이동하신 후 ‘결제 내역’에서 확인하실 수 있습니다."},

    ],

    Payment : [
      { "title" : "어떻게 결제하나요?", "detail":"1. 화면 상단의 ‘서비스 이용’의 ‘설문 응답 서비스’ 클릭 시, 화면 우측 주문창에 설문 옵션을 선택해주세요.\n 2. 설문 기본 옵션을 모두 선택하셨다면 ‘상세 정보 입력하기’를 클릭한 뒤 주문을 완료해주세요.<br/>3. 알림창에 있는 계좌로 설문 금액을 입금해주시면 됩니다."},
      ...
      { "title" : "응답 수가 미달될 경우, 환불 절차는 어떻게 되나요?","detail":"응답 수가 미달될 경우, 미달된 응답수에 해당하는 비율만큼 부분 환불을 도와드리고 있습니다. \n 환불 절차는 회원가입 시 기입하신 연락처 또는 카카오톡 채널(@surveasy)을 통해 안내드립니다. \n 환불 예시: 응답 수 30명 요청, 20명 응답 시 → 결제 금액의 1/3 환불 진행"},
    ],
