...
export default createStore({
  state: {
    ...
    priceTable: [  
      [ [5400, 5400,	7200,	9000,	10800, 12600, 14400, 16200, 18000],
        [5400, 5400,	7200,	9000,	10800, 12600, 14400, 16200, 18000],
        [16200, 16200, 21600, 27000, 32400, 37800, 43200, 48600, 54000],
        [32400, 32400, 43200, 54000, 64800, 75600, 86400, 97200, 108000],
        [54000, 54000, 72000, 90000, 108000, 126000, 144000, 162000, 180000],
        [81000, 81000, 108000, 135000,	162000, 189000, 216000,	243000, 270000],
        [108000, 108000, 144000, 180000, 216000, 252000, 288000, 324000, 360000]  ],
      ...
      [ [7200, 7200, 9600, 12000, 14400, 16800, 19200, 21600, 24000],
        [7200, 7200, 9600, 12000, 14400, 16800, 19200, 21600, 24000],
        [21600, 21600, 28800, 36000, 43200, 50400, 57600,	64800, 72000],
        [43200, 43200, 57600, 72000, 86400, 100800, 115200, 129600, 144000],
        [72000, 72000, 96000, 120000, 144000, 168000, 192000, 216000, 240000],
        [108000, 108000, 144000, 180000, 216000, 252000, 288000, 324000, 360000],
        [144000, 144000, 192000, 240000, 288000, 336000, 384000, 432000, 480000] ],
    ...
    EngOptionArray: [ 0, 0.8, 1.2 ],

    AgeOptionArray: [ 0, 0, 0.2, 0.3, 0.3, 0.1, 0.1],

    genderOptionArray: [0, 0, 0.4, 0.4],
    ...
    priceTextTable: [
      ...
      [ '', '1분 이내', '1~3분', '4~6분', '7~10분', '11~15분', '16~20분', '21~25분' ],
