...
export default createStore({
  state: {
    ...
    MemberInfo : [
      { "title" : "아이디/비밀번호는 어디서 변경할 수 있나요?", "detail":"<b>[아이디 변경]</b><br>서베이지 카카오톡 채널 @surveasy로 연락주시면 도와드리겠습니다.<br><b>[비밀번호 변경]</b><br>LOGIN 페이지에서 ‘비밀번호 찾기’ 버튼을 누르신 뒤 안내에 따라 비밀번호를 변경하시면 됩니다."},
    ...
    Payment : [
      ...
      { "title" : "응답 수가 미달될 경우, 환불 절차는 어떻게 되나요?","detail":"응답 수가 미달될 경우, 미달된 응답수에 해당하는 비율만큼 부분 환불을 도와드리고 있습니다. 환불 절차는 회원가입 시 기입하신 연락처 또는 카카오톡 채널(@surveasy)을 통해 안내드립니다. <br><br><i>환불 예시: 응답 수 30명 요청, 20명 응답 시 → 결제 금액의 1/3 환불 진행</i>"},
    ],
