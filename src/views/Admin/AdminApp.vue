...
<div id="adminApp-continer">
  ...
  <div class="admin-index">
    ...
    <router-link to="/adminapp/ios_panelsent" class="adminApp-btn">ios 정산</router-link>
    <router-link to="/adminapp/ios_panelinfo" class="adminApp-btn">ios 패널 정보</router-link>
