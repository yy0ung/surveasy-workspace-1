...
<div id="knowhow-item-container">
  <div class="knowhow-contents">
    ...
    <div class="knowhow-content">
      <p><img class="img1" src="@/assets/knowhow/one/surveytips8thumbnail.png" width="500"></p>
    ...
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips8image(1).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips8image(2).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips8image(3).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips8image(4).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p class="black-light">드롭다운은 옵션이 너무 많아 문항이 복잡해 보일 때 옵션들을 깔끔하게 모아서 보여줄 수 있습니다. 옵션이 10개 이상인 질문을 객관식으로 만들면 설문지도 굉장히 길어지고, 응답자 입장에서 문항이 장황해 보이기 때문에 드롭다운으로 싹 정리하면 됩니다.</p>
        <p><img class="img" src="@/assets/knowhow/one/surveytips8image(5).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips8image(6).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips8image(7).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips8image(8).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips8image(9).png" width="600"></p>
