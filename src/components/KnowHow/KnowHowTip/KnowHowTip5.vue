...
<div id="knowhow-item-container">
  <div class="knowhow-contents">
    ...
    <div class="knowhow-content">
      <p><img class="img1" src="@/assets/knowhow/one/surveytips5thumbnail.png" width="500"></p>
    ...
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips5image(1).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips5image(2).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips5image(3).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips5image(4).png" width="600"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips5image(5).png" width="600"></p>
