...
<div id="knowhow-item-container">
  <div class="knowhow-contents">
    ...
    <div class="knowhow-content">
      <p><img class="img1" src="@/assets/knowhow/one/surveytips3thumbnail.png" width="500"></p>
    ...
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips3image(1).png" width="450"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips3image(2).png" width="800"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p class="black-light">설정에서 ‘퀴즈로 만들기’를 누르면 설문을 퀴즈 형식으로도 만들 수 있습니다. 또한 응답자는 퀴즈(응답)를 제출하면 바로 채점 결과를 확인할 수 있습니다. 상세 설정을 통해 응답자가 틀린 문제, 정답, 점수까지 확인할 수 있게끔 별도 설정이 가능합니다.</p>
        <p><img class="img" src="@/assets/knowhow/one/surveytips3image(3).png" width="800"></p>
        <p><img class="img" src="@/assets/knowhow/one/surveytips3image(4).png" width="800"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p><img class="img" src="@/assets/knowhow/one/surveytips3image(5).png" width="800"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p class="black-light">네이버폼에는 메일 알림 기능이 있습니다. 실시간으로 설문 응답을 한 결과가 메일로 전송됩니다. 따라서 새 응답이 있는지 계속해서 확인을 할 필요가 없습니다. 설정 방법은 [응답 설정]에서 [응답 제출 시 메일 받기]를 선택하면 됩니다.</p>
        <p><img class="img" src="@/assets/knowhow/one/surveytips3image(6).png" width="700"></p>
        ...
        설문지 제작이 완료되면, 서베이지의 설문 응답 서비스로 손쉽게 응답을 수집해 보는 건 어떨까요?</p>
    </div>
  </div>
</div>
