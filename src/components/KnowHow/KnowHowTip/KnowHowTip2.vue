...
<div id="knowhow-item-container">
  <div class="knowhow-contents">
    ...
    <div class="knowhow-content">
      <p><img class="img1" src="@/assets/knowhow/one/surveytips2thumbnail.png" width="500"></p>
      <p class="black-bold-">서베이지의 EASY한 꿀팁 두 번째에서는 설문조사를 진행할 만한 주제를 판단하는 법을 알려드립니다.</p>
    </div>
    <div class="knowhow-content">
    ...
    <div class="knowhow-content">
      ...
      <p class="black-light">다만, 수치로 표현하기 어려운 주관적인 내용이나 깊은 인사이트를 얻기 위해서는 설문조사보다 인터뷰 등의 리서치 방식이 더 효과적이라고 할 수 있습니다.</p>
        <p><img class="img" src="@/assets/knowhow/one/surveytips2image(2).jpeg" width="800"></p>
    </div>
    <div class="knowhow-content">
      ...
      <p class="black-light">설문조사는 적당한 길이를 유지해야 하기 때문에, 효율적으로 질문을 하는 것이 중요합니다. 아래와 같은 사항들을 고려하여 버려지는 문항이 없게끔 유의할 필요가 있습니다.</p>
        <p><img class="img" src="@/assets/knowhow/one/surveytips2image(3).png" width="800"></p>
