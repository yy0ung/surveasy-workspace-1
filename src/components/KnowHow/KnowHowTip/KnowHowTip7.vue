...
<div id="knowhow-item-container">
  <div class="knowhow-contents">
    ...
    <div class="knowhow-content">
      <p><img class="img1" src="@/assets/knowhow/one/surveytips7thumbnail.png" width="500"></p>
      <p class="black-bold-">설문지가 완성되었어도 배포하기 전 첫 화면에 본 조사에 대한 간단한 설명을 추가해 주는 것이 좋습니다.<br>설문조사 설명란에 어떤 내용을 포함하면 좋을지 알아보겠습니다.</p>
      <p><img class="img--" src="@/assets/knowhow/one/surveytips7image(1).png" width="800"></p>
    </div>
    <div class="knowhow-content">
