<template>
 <div class="container">
		<div class="row justify-content-center align-items-center">
            ...
            <h3 class="service-title m-3">인터뷰이 모집 서비스</h3>
			        <div class="row">
                <div class="form-group row">
            <p class="form-title m-1">모집기한</p>
            <div class="col-6">
          ...
          <div class="show-price-container">
            ...
            <a class="btn btn-primary w-50" @click="setOption1()">인터뷰 정보 입력 ></a>
          </div>
            </div>
            </div>   
</div>
