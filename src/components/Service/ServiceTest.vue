<template>
  <div>
    ...
    <select v-model="priceRequireHeadCount">
    ...
    <div>
      ...
      <br>
      영어 설문 여부
      <input type="radio" v-model="addENTarget" :value=0 name="enTarget">선택 안함
      <input type="radio" v-model="addENTarget" :value=1 name="enTarget">영어 설문(50명 이하)
